...
export class DynamicTableListComponent implements OnInit {
  ...
  @Output() countChanged: EventEmitter<any> =   new EventEmitter();
      ...
      selectFlag=false;
      columnsSelected=[]
      displayedColumns:any;// = [] //this.columns.map(c => c.columnDef);
      actionColumns:any;// = []
      ...
      ngOnInit(){
        ...
        // console.log(' ngOnInit table-fil-sort-pag data '+JSON.stringify(this.echangeData.data))
            ...
            console.log("this.columnsAction ",JSON.stringify(this.columnsAction ))
    ...
    if (!value.includes(ele.toUpperCase())) return ele;
     ...
     generateActionColums(){
      ...
      for ( var i=0;i<ar.length;i++ ){
       ...
       console.log("generateActionColums ",ar[i])
       jjson.push(tmpjson);
      ...
      generateDisplyColumns(){
        ...
        if ( this.echangeData.displayedColumns.length>0 ){
          this.displayedColumns = this.echangeData.displayedColumns//columns.map(c => c.columnDef);
            ...
            this.displayedColumns = this.columns.map((c: { columnDef: string }) => c.columnDef);
          }
