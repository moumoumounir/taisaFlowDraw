...
export class composantCrudComponent implements OnInit {
...
if (this.uploadFilePath instanceof File) {
  ...
  public updateJsonDataToSheet(data:any): Promise<any>{
    // let paramString1='colName=Ref_Request&colValue='+this.echangeData['Ref_Request']+'&sheet=userRequestValidation'
     ...
     return this.mainService.updateJsonDataToSheet(data,this.sheet).toPromise()
  }
